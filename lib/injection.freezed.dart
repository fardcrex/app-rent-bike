...
/// @nodoc
class _$Dev with DiagnosticableTreeMixin implements Dev {
  const _$Dev();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties..add(DiagnosticsProperty('type', 'Env.dev'));
  }
...
/// @nodoc
class _$Prod with DiagnosticableTreeMixin implements Prod {
  const _$Prod();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'Env.prod'));
  }
...
/// @nodoc
class _$Test with DiagnosticableTreeMixin implements Test {
  const _$Test();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'Env.test'));
  }
