...
// ignore: unused_element
  _AppState call({AppMenu appMenu, bool isLoading}) {
    return _AppState(
      appMenu: appMenu,
      isLoading: isLoading,
    );
...
class _$_AppState implements _AppState {
  const _$_AppState({this.appMenu, this.isLoading});
  ...
  @override
  String toString() {
    return 'AppState(appMenu: $appMenu, isLoading: $isLoading)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState({AppMenu appMenu, bool isLoading}) = _$_AppState;
